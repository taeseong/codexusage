...
CodexUsage runs locally. It does not read or save Codex tokens, browser cookies, passwords, or chat content, and it does not send usage data to an external service. See [SECURITY.md](docs/SECURITY.md) for details.
